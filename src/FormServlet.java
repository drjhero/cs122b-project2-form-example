...
public class FormServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (Connection dbCon = dataSource.getConnection();
            ...
            // Retrieve parameter "name" from the http request, which refers to the value of <input name="name"> in
            // index.html
            ...
            try (ResultSet resultSet = statement.executeQuery(query)) {
                ...
                // Iterate through each row of resultSet and create a table row <tr>
            ...
            out.println(String.format(
                    "<html><head><title>MovieDBExample: Error</title></head>\n" +
